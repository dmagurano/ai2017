	                    ...
	                    <tr>
	                        ...
	                        <div class="media">
	                            ...
	                            <div class="media-body">
	                                <h4 class="media-heading"><a href="#"><%= ticket.getKey().getType().toString().replace("_", " ") %></a></h4>
	                                <span>Status: </span><span class="text-success"><strong>In Stock</strong></span>
	                            </div>
	                        </div></td>
	                        <td class="col-sm-1 col-md-1" style="text-align: center">
	                        <input type="number" class="form-control" name=<%= ticket.getKey().getType().toString() %> value=<%=ticket.getValue() %>>
	                        </td>
