<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	pageEncoding="ISO-8859-1" import="it.polito.madd.model.Ticket,java.util.ArrayList"%>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
						...
						<form role="form" id="addCart" name="addCart" action="/Lab1/cart"
			    			...
			    			<div class="form-group">		 
								<div class="form-inline">
									<label class="control-label col-md-7" style="margin:5px; text-align: right" for="<%= ticketName %>"> 
