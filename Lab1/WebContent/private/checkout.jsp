					...
					<div class="col-sm-8 col-sm-offset-2 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2">
						...
						<div class="col-sm-12 col-md-12 col-lg-12">
							...
							<form action="/Lab1/private/payment" method="POST">
								<label for="number">Credit card number </label><input type="number" class="form-control" name="number" min="0" value="<%= n %>">
								<label for="holder">Card holder </label><input type="text" class="form-control" name="holder" value="<%= h %>">
								<label for="cvv">CVV </label><input type="number" class="form-control"  min="0" max="999" name="cvv" value="<%= c %>">
								<hr>								
